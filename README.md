...
|4.|• Capturing user input <br>• Events • [Basic DOM manipulations (img src, innerHTML)](fundamentals/DOM_manipulation)<br>• Code debugging using the browser <br>• [Code commenting](fundamentals/code_commenting.md)<br>• Structuring code files |[Reading Week 4](/Week4/README.md)|[Homework Week 4](/Week4/MAKEME.md)|
