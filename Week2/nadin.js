...
//const res = myString.split();
console.log(newString, res);
...
console.log(
  'i think the new value of the array is:,["blowfish", "meerkta", "capricorn", "giraffe", "turtle"]',
);
console.log(favoriteAnimals);
...
console.log(typeof typeof bar);
  console.log(
    "typeof typeof bar: is string because we asked about the type of the word 'bar' which is string not about the type of the value of the variable bar which is number"
  );
