...
function tellFortune(child, partener, location, job) {
    ...
    console.log(
        `You will be a ${job} in ${location}, and married to ${partener} with ${child} Kids`
    );
}
...
function newTellFortune(child, partener, location, job) {
    ...
    console.log(
        `You will be a ${numJobs} in ${numLocationes}, and married to ${parteners} with ${childern} Kids`
    );
}
